...
def less_puppies(number_of_puppies)
  if number_of_puppies>3
    "Gets back toy your animal goals"
...
def some_puppies(number_of_puppies,max_allowence)
   if number_of_puppies< 0.5*max_allowence
    "Good job, Rachel"
    elsif number_of_puppies>max_allowence
    "Get back to your animal goals!"
  end
end
